// Consolidated analytics helper functions
...
export const REVERSE_DAY_MAPPING = {
  'Monday': 'Mon',
  'Tuesday': 'Tue',
  'Wednesday': 'Wed',
  'Thursday': 'Thu',
...
export const formatDayDisplay = (day) => REVERSE_DAY_MAPPING[day] || day
export const getFullDayName = (shortDay) => DAY_MAPPING[shortDay] || shortDay
