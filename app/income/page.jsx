...
const Income = () => {
  ...
  return (
    <div className="min-h-[100dvh] bg-background text-text flex flex-col p-4 md:p-6 lg:p-8">
      <div className="max-w-[1400px] mx-auto w-full">
        ...
        {isLoading ? (
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mt-6 animate-pulse">
            {[...Array(12)].map((_, index) => (
              <div key={index} className="h-[200px] bg-text/10 rounded-lg"></div>
            ))}
          </div>
        ) : (
